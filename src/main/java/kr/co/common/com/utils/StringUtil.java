...
public class StringUtil
{
  ...
  public static String randomValue(String type, int cnt) {
    ...
    return strPwd.toString();
  	...
  	/*
	 * list의 특정 문자 찾기 그에 해당하는 map의 값 추출
	 * 
	 * ex) list의 name 이 "LEE" 인 데이터의 age를 가져올때 
	 * compareString(list,"name","LEE","age")
	 * */
	public static String compareString(List<Map<String, Object>> list , String Key , String str  , String returnkey ) {
		String result = null;
		for(int i=0 ; i<list.size();i++){
			if(str.equals(list.get(i).get(Key))){
				result = list.get(i).get(returnkey).toString();
				break;
			};
		};
		return result;
 	...
 	/*
	 * list의 특정 문자 찾기 그에 해당하는 map 추출
	 * 
	 * ex) list의 name 이 "LEE" 인 데이터의 Map 를 가져올때 
	 * compareString(list,"name","LEE")
	 * */
	public static Map<String,Object> compareMap(List<Map<String, Object>> list , String Key , String str ) {
	...
	/*
	 * json to  List<Map>
	 * getListMapFromJsonStr
	 * */
	public static List<Map<String, Object>> getListMapFromJsonStr(String json){
