    ...
    $("#my_file_input").on("change", function(e){
        ...
        for (i = 0; i != files.length; ++i) 
        {
            ...
            reader.onload = function(e) 
            {
                ...
                {
                    var jsExcel = XLSX.utils.sheet_to_json(workbook.Sheets[sheetName], {header:1});
                    if(jsExcel.length) result[sheetName] = jsExcel;
                });
//                 console.log(JSON.stringify(result));
                var temp = JSON.stringify(result, null, 2);
                console.log(temp);
            }; 
...
<div id="searchArea" class="H50">
    ...
    <%-- Excel Download Parameter--%>
        ...
        <table class="searchTable">
            ...
            <tbody>
                <tr>
                    <td><input type="file" id="my_file_input"></td>
                </tr>
            </tbody>
        </table>
    </form>
