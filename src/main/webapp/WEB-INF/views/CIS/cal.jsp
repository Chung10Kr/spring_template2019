	...
	document.addEventListener('DOMContentLoaded', function() {
	    ...
	    var calendar = new FullCalendar.Calendar(calendarEl, {
	      ...
	      eventClick:function(info){
	    	  console.log( 'click Event: ' + info.event.groupId  )
	    	  fnOpenLayerPop();
	      },
	      ...
	      events: [
	        {id:'a',title: 'Auditorium A',start: '2019-12-05T16:00:00',end:'2019-12-07T16:00:00',backgroundColor:'#343a40',borderColor:'#343a40'},
	      ] 
	      */ 
        ...
        <table class="searchTable">
            ...
            <tbody>
                <tr>
                    ...
                    <th>상위코드명</th>
                    <td><input type='text' id='major_nm' name='major_nm'></td>
                </tr>
            </tbody>
        </table>
    </form>
...
<jsp:include page='CIS1150P0.jsp'></jsp:include>
