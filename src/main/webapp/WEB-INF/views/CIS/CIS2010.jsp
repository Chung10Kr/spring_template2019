...
var columns1 =
[
	{header:'comp_nm',name:'comp_nm',editor:{type:'text'}, ChgFunc: "fnUpdate" },
	{header:'addr',name:'addr',editor:{type:'text'}, ChgFunc: "fnUpdate" },
	{header:'corp_regt_num',name:'corp_regt_num',editor:{type:'text'}, ChgFunc: "fnUpdate" },
	{header:'ceo_nm',name:'ceo_nm',editor:{type:'text'}, ChgFunc: "fnUpdate" },
	{header:'biz_typ',name:'biz_typ',editor:{type:'text'}, ChgFunc: "fnUpdate" },
	{header:'biz_kind',name:'biz_kind',editor:{type:'text'}, ChgFunc: "fnUpdate" },
...
function fnSelect() {
	...
	frm.mapper_id.value="CIS2010.getList";
	
	var url = "/JOB/CIS2010/getList";
...
function fnDelete() {
	...
	frm.mapper_id.value="CIS2010.delete";
	frm.data.value=JSON.stringify( checkedData ) ;
	var sendData = $("#editForm").serialize();

	var url = "/JOB/CIS2010/delete";
 	var sucessFunc = function(data) {
 		fnSelect();
 	};
 	G_AJAX.ajaxCall(url , sendData , sucessFunc );
	...
	<%-- Select Parameter--%>
		...
		<table class="searchTable">
			...
			<tbody>
				<tr>
					<th>comp_nm</th>
					<td><input type="text" name="comp_nm" class="entrKey"title="회사명"></td>
					<th>use_yn</th>
					<td><select name="use_yn" class="" select-type="-ALL-" title="사용여부"></td>
