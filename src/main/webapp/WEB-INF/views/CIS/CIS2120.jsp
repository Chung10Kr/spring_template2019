...
[
	...
	{header:'mdl_nm',name:'mdl_nm',editor:{type:'text'}, ChgFunc: "fnUpdate"},
...
function fnSelect() {
	...
	frm.mapper_id.value="CIS2120.getList";
	
	var url = "/JOB/CIS2120/getList";
...
function fnDelete() {
	...
	frm.mapper_id.value="CIS2120.delete";
	frm.data.value=JSON.stringify( checkedData ) ;
	var sendData = $("#editForm").serialize();

	var url = "/JOB/CIS2120/delete";
 	var sucessFunc = function(data) {
 		fnSelect();
 	};
 	G_AJAX.ajaxCall(url , sendData , sucessFunc );
	...
	<%-- Select Parameter--%>
		...
		<table class="searchTable">
			...
			<tbody>
				<tr>
					<th>comp_cd</th>
					<td><select name="comp_cd" select-type='-ALL-'></td>
					<th>mdl_nm</th>
					<td><input type="text" name="mdl_nm" class="entrKey W300"></td>
				</tr>
			</tbody>
		</table>
	</form>
