...
[
	...
	{header:'attach_no',name:'attach_no',editor:{type:'text'}, ChgFunc: "fnUpdate"},
...
function fnSelect() {
	...
	frm.mapper_id.value="CIS2030.getList";
	
	var url = "/JOB/CIS2030/getList";
...
function fnDelete() {
	...
	frm.mapper_id.value="CIS2030.delete";
	frm.data.value=JSON.stringify( checkedData ) ;
	var sendData = $("#editForm").serialize();

	var url = "/JOB/CIS2030/delete";
 	var sucessFunc = function(data) {
 		fnSelect();
 	};
 	G_AJAX.ajaxCall(url , sendData , sucessFunc );
